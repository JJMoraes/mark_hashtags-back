...
public class HashtagResourceTests {
  ...
  public void saveTest() throws Exception {
    String hashtagString =
        "{\"title\":\"#DesafioMagrathea\", \"owner\":{\"id\":1, \"email\":\"jean@gmail.com\", \"username\":\"jeanklose\"}}";
    MvcResult result =
        this.mockMvc
            .perform(
  ...
  public void getByIdTest() throws Exception {
    MvcResult result =
        this.mockMvc.perform(get("/hashtag/1")).andExpect(status().isOk()).andReturn();
  ...
  public void getAllByOwnerIdTest() throws Exception {
    MvcResult result =
        this.mockMvc.perform(get("/hashtag/owner/1")).andExpect(status().isOk()).andReturn();
  ...
  public void getAllTweetsByHashtagIdTest() throws Exception {
    MvcResult result =
        this.mockMvc.perform(get("/hashtag/1/tweets")).andExpect(status().isOk()).andReturn();
